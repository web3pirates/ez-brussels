...
export function Footer() {
  ...
  const ensName = useEnsName({ address, blockTag: "latest", chainId: 8453 });
  return (
    <Wrapper>
      <Links>
        <Socials>
          <Image
            src="https://ca.slack-edge.com/T02742R3GCA-U06HUN592C8-e53fb61db2af-192"
            alt="EEZY"
            width={32}
            height={32}
          />
      ...
      <Links>
        ...
        <Link href="https://github.com/web3pirates/ez-brussels" target="_blank">
          <GithubIcon />
        </Link>
      </Links>
    </Wrapper>
