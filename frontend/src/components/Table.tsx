...
function LeaderboardRow(props: { user: { id: string; gained: number }; idx: number }) {
  ...
  return (
    <tr key={idx}>
      <td className={`whitespace-nowrap p-[0.9375rem] text-custom-gray-uni relative rounded-2xl`}>
        <div
